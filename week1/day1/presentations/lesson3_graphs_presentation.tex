...
\begin{document}
\input{lesson3_graphs_presentation-concordance}
...
\end{Sinput}
\end{Schunk}
\includegraphics{lesson3_graphs_presentation-002}
...
\end{Sinput}
\end{Schunk}
\includegraphics{lesson3_graphs_presentation-004}
\end{figure}
\end{center}
...
\begin{Schunk}
\begin{Sinput}
> pie(table(maltreat$sex), col=c("red","blue"),
+     main="Pie chart of gender")
\end{Sinput}
\end{Schunk}
\includegraphics{lesson3_graphs_presentation-007}
\end{figure}
\end{center}
